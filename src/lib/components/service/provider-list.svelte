...
<div class="m-5" in:fade={{duration: 200}}>
    ...
    <div class="d-flex flex-row-reverse align-items-center pb-3">
        ...
        <a class="link-primary me-2" href="#" data-bs-toggle="collapse" role="button" aria-expanded="false" data-bs-target="#filer-options-collapse" aria-controls="filer-options-collapse">
