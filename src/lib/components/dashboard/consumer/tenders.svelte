<script lang="ts">
    ...
    let bids: {id: number, bidTitle: string, tenderTitle: string, description: string}[] = [];
    let tendersReady: boolean = false;
    let tenders: {id: number, title: string, description: string, created: string, ends: string}[] = [];
    ...
    function FetchTenders(): void
    {
        ...
        }).then(async (response: Response): Promise<void> =>
        {
            ...
            tenders = new Array<{id: number, title: string, description: string, created: string, ends: string}>(responseObject.length);
    ...
    function FetchAllTenders(): void
    {
        ...
        }).then(async (response: Response): Promise<void> =>
        {
            ...
            bids = new Array<{id: number, bidTitle: string, tenderTitle: string, description: string}>(responseObject.length);
            ...
            for(let i: number = 0; i < bids.length; ++i)
            {
                ...
                {
                    id: responseObject[i]._tenderid,
                    bidTitle: responseObject[i]._title,
                    tenderTitle: "",
                    description: responseObject[i]._description
                }
            }
