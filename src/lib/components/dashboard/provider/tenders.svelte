<script lang="ts">
    ...
    function FetchBadeTenders(): void
    {
        fetch("/api/tender/provider_bid_tenders",
        {
            method: "POST",
            headers:
            {
    ...
    function FetchAllTenders(): void
    {
        fetch("/api/tender/all_tender",
        {
            method: "POST",
            headers:
            {
        ...
        }).then(async (response: Response): Promise<void> =>
        {
            ...
            allTendersReady = true;
        });
    }    

    function ShowAllTenders(): void
    {
        allTendersReady = false;
        showAllTenders = true;
...
<div class="tenders-root" in:fade={{duration: 200}}>
    {#if showAllTenders}
        <div class="all-tenders" in:fade={{duration: 200}}>
            <h4 class="all-tenders-title d-flex align-items-center m-0">
                            ...
                            <a role="button" class="list-group-item list-group-item-action" href="#">
                                <div class="m-1">
                                    ...
                                    <div class="d-flex align-items-center text-body-secondary ms-1">
                                        <div title="Tender Created Date" class="d-flex align-items-center">
                                        ...
                                        <div title="Tender End Date" class="d-flex align-items-center">
        ...
        <div class="bade-tenders" in:fade={{duration: 200}}>
            ...
            <div class="bottom-part">
                <div class="d-flex flex-row-reverse">
                    <button type="button" class="btn btn-success" title="Add New Tender" on:click={ShowAllTenders}>
