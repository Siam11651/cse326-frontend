        ...
        <div class="partition-right p-5">
            <div class="accessories-container p-3">
                <div class="input-group input-group-sm">
                    <input type="text" class="form-control" placeholder="Search Service" aria-label="Search Service" aria-describedby="search-service-button" bind:value={searchTerm} title="Search">
                    <button class="btn btn-primary" type="button" id="search-service-button">
