            ...
            <div class="side-menu d-flex flex-column align-items-center justify-content-between border-end">
                ...
                <div class="menu-list-container ps-3 mb-3 mt-5">
                    <div class="list-group list-group-flush border border-end-0 rounded-start">
                        <button type="button" class="menu-button list-group-item list-group-item-action fs-4 active" bind:this={menuButtons[0]} on:click={OnOverviewMenuClick}>Overview</button>
                        <button type="button" class="menu-button list-group-item list-group-item-action fs-4" bind:this={menuButtons[1]} on:click={OnServicesMenuClick}>Services</button>
                        <button type="button" class="menu-button list-group-item list-group-item-action fs-4" bind:this={menuButtons[2]} on:click={OnTasksMenuClick}>Tasks</button>
                        <button type="button" class="menu-button list-group-item list-group-item-action fs-4" bind:this={menuButtons[3]} on:click={OnHistoryClick}>History</button>
                        <button type="button" class="menu-button list-group-item list-group-item-action fs-4" bind:this={menuButtons[4]} on:click={OnReviewsClick}>Reviews</button>
                    </div>
                </div>
            </div>
