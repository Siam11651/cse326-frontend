CREATE OR REPLACE FUNCTION public.get_matching_providers_consumer_location(given_serviceid integer, given_consumerid integer)
...
begin
	...
	return query
		...
		order by
			(public.get_matching_local_area_count(p.pid, given_consumerid)) desc;
end;
$function$
;
