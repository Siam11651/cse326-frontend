CREATE OR REPLACE FUNCTION public.filter_provider_service_by_discount(given_serviceid integer, starting_rate numeric, ending_rate numeric)
...
begin
	...
	return query
		...
		where
			...
			and
			(
			p2.discountpercentage between starting_rate and ending_rate
			)
		order by
			ratingrank desc;
end;
