CREATE OR REPLACE FUNCTION public.filter_provider_service_by_rating(given_serviceid integer, starting_rate numeric, ending_rate numeric)
...
begin
	...
	return query
		...
		where
			...
			, 0) between starting_rate and ending_rate
			)
		order by
			ratingrank desc;
end;
