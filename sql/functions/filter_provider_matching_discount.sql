CREATE OR REPLACE FUNCTION public.filter_provider_service_matching_cost(given_serviceid integer, given_cost numeric)
...
begin
	...
	return query
		...
		where
			...
			and
			(_basecost - _basecost * (p2.discountpercentage / 100.0)) = given_cost
		order by
			ratingrank desc;
end;
$function$
